package com.devstup.rest.webservices.restfulwebservices;
...
public class SwaggerConfig {
    public static final Contact DEFAULT_CONTACT = new Contact("Barış Gündüz", "http://www.barisgunduz.com", "barisgunduz@outlook.com");
    public static final ApiInfo DEFAULT_API_INFO = new ApiInfo(
            "Api Title", "Api Description", "1.0",
            "urn:tos", "Barış Gündüz", "Apache 2.0",
